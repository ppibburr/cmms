...
self << List.new(header: ["Interval", "Craft","Dept","Equip", "Description"], columns: [0, 0,1,1, 3] ,data: (data["tasks"]||[]).map do |t| [t["interval"],t["craft"], t["department"], t["equip-name"], t["description"]] end) {
  this=self
  render do |_,r,c|
    ele(:div) {
      next _ if r < 0
